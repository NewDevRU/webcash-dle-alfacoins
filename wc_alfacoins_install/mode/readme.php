...
<p>
	С помощью этого шлюза пользователь сайта может осуществлять платежи через систему ALFAcoins на вашем сайте. Шаблон платежной формы шлюза находится в папке &laquo;/modules/webcash/gateways/alfacoins/&raquo;.
</p>
...
<ul onload="init();">
	<li>1) Скопировать содержимое папки &laquo;/wc_alfacoins_install/files/&raquo; в корень сайта<br /><br /></li>
	
	<li>
		2) 
		<?php
		$fname = ROOT_DIR.'/wc_alfacoins_install/append/config.webcash.php';
...
<ul class="list2">
	<li><b>Вопрос:</b> Как удалить шлюз или при необходимости снова прочитать инструкцию по подключению без запуска установки</li>
	<li><b>Ответ:</b> Удалить шлюз можно по ссылке <a href="/wc_alfacoins_install/index.php?mode=uninstall" target="_blank">/wc_alfacoins_install/index.php?mode=uninstall</a>, а прочитать инструкцию без запуска установки платежного шлюза по ссылке <a href="/wc_alfacoins_install/index.php?mode=readme" target="_blank">/wc_alfacoins_install/index.php?mode=readme</a>.</li>
</ul>